...
export function SiteFooter() {
  ...
  return (
    <footer className="bg-[var(--primary)] text-white/85 mt-24">
      <div className="container-wide py-12 md:py-24 grid grid-cols-2 md:grid-cols-12 gap-10 md:gap-16">
        <div className="col-span-2 md:col-span-5">
          <img src={logo} alt="CESC — Chinese Enterprises Society of Canada" className="h-16 md:h-24 w-auto object-contain" />
          <p className="mt-6 md:mt-8 text-sm leading-relaxed text-white/70 max-w-md">
        ...
        <div className="md:col-span-2 md:col-start-7">
          <h4 className="font-sans text-sm uppercase tracking-[0.18em] text-[var(--gold)] mb-4">{t("Navigation")}</h4>
        ...
        <div className="md:col-span-2">
          <h4 className="font-sans text-sm uppercase tracking-[0.18em] text-[var(--gold)] mb-4">{t("Community")}</h4>
          <ul className="space-y-2 md:space-y-3 text-sm">
        ...
        <div className="col-span-2 md:col-span-2">
          <h4 className="font-sans text-sm uppercase tracking-[0.18em] text-[var(--gold)] mb-4">{t("Contact")}</h4>
          <ul className="space-y-2 md:space-y-3 text-sm">
